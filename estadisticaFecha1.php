...
<form id="form1" name="form1" onsubmit="return validar()" method="get" action="principal.php">
  <table width="331" class="bordes" border="1" align="center">
    ...
    <tr>
      <td width="98" class="negrita">Desde:</td>
    ...
    <tr>
      <td class="negrita">Hasta:</td>
      <td><input name="fecha2" type="text" id="fecha2" value="" size="15" maxlength="10" readonly="readonly"//>
    ...
    <tr>
      <td colspan="2" align="center" bgcolor="#990033"><label>
        ...
        <input type="hidden" name="link" value="link29" />
      </label></td>
    </tr>
  </table>
  <p>&nbsp;</p>
