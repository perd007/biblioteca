...
$query_usu = "SELECT fecha FROM usuario Where fecha='$fecha'";
...
if( $totalRows_usu==0){
 		echo "<script type=\"text/javascript\">alert ('No existen usuario en esta Fecha'); location.href='Principal.php?link=link13' </script>";
  		exit;
}
?>
...
<table width="494" border="1" align="center" cellpadding="0" cellspacing="0" class="bordes">
  <tr bgcolor="#990033">
    <th width="134" rowspan="2" align="center" valign="bottom" scope="col"><span class="blancas">Fecha</span></th>
    <th colspan="3" align="center" bgcolor="#990033" scope="col"><span class="blancas">Usuarios</span></th>
  </tr>
  <tr class="centrar">
    <td width="101" bgcolor="#990033"><span class="blancas">Sala</span></td>
    <td width="104" bgcolor="#990033"><span class="blancas">Circulante</span></td>
    <td width="127" bgcolor="#990033"><span class="blancas">Aula</span></td>
  </tr>
  <?php
  $contador1=0;
  $contador2=0;
