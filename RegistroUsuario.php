...
if($validacion==true){
	if($Admi==0){
	echo "<script type=\"text/javascript\">alert ('Usted no posee permisos para registrar usuarios ');location.href='principal.php' </script>";
    exit;
	}
}
else{
...
<form id="form1" name="form1" method="post" onSubmit="return validar()"  action="<?php echo $editFormAction; ?>">
  <table class="bordes" width="577" border="0" align="center" cellspacing="0">
    <tr bgcolor="#00CCFF" >
    ...
    <tr>
      <td colspan="2" bgcolor="#990033" scope="row"><div align="right">
        <div align="center" class="blancas">Permisos</div>
      </div></td>
    </tr>
    <tr >
    ...
    <tr>
      <th colspan="2" align="center" bgcolor="#990033" scope="row"><label>
